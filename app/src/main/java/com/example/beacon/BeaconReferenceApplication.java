...
public class BeaconReferenceApplication extends Application implements BootstrapNotifier {
    ...
    public void onCreate() {
        ...
        beaconManager.getBeaconParsers().addAll(Arrays.asList(new BeaconParser().setBeaconLayout(BeaconParser.EDDYSTONE_UID_LAYOUT),
...
//        Log.d(TAG, "Sending notification.");
        //sendNotification();
        System.out.println("UM BEACON ENTROU NA REGION");
